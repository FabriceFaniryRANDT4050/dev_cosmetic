...
const renderTabContent = (activeTab) => {
  const data = ProductData.tabsContent[activeTab];
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white font-sans shadow-2xl rounded-xl overflow-hidden">
          ...
          <div className="pt-6 space-y-4">
              <div className="flex items-end justify-between">
                ...
                <div className="text-sm text-gray-500 text-right">
                    ...
                    <p className="text-xs">Prix au L : <span className="font-bold">{ProductData.pricePerLiter.toFixed(1).replace('.', ',')} €</span></p>
                </div>
              </div>
      ...
      <div className="p-6 md:p-12">
        ...
        {/* Section Avis (Simulation) */}
        <div className="mt-12 pt-8 border-t border-gray-200">
            <h2 className="text-3xl font-bold mb-8" style={{ color: COLOR_TEXT }}>
                Avis Clients
            </h2>
            <p className="text-gray-700 text-left mb-6">Basé sur **{ProductData.reviewCount} avis clients**. Cliquez ici pour lire ou laisser un avis.</p>
