    ...
    <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label htmlFor="Nom" className="block text-left text-sm/6 font-semibold text-white">
              Nom
            </label>
          ...
          <div>
            <label htmlFor="prenom" className="block text-left text-sm/6 font-semibold text-white">
              Prénom(s)
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-left text-sm/6 font-semibold text-white">
              Adresse
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="email" className="block text-left text-sm/6 font-semibold text-white">
              Email
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="phone-number" className="block text-left text-sm/6 font-semibold text-white">
              Télephone
            </label>
            <div className="mt-2.5">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="message" className="block text-left text-sm/6 font-semibold text-white">
              Messages
            </label>
            <div className="mt-2.5">
              <textarea
